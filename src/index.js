  ...
  try {
    ...
    if (interaction.commandName === "plainte") {
      ...
      if (accuse.id === interaction.user.id) {
        return interaction.reply({
          content: "❌ Tu ne peux pas porter plainte contre toi-même.",
          ephemeral: true
        });
      }
    ...
    if (interaction.commandName === "avocat") {
      ...
      if (plainte.statut === "Fermée") {
        return interaction.reply({
          content: "❌ Cette affaire est fermée.",
          ephemeral: true
        });
      }
      ...
      if (plainte.avocat) {
        return interaction.reply({
          content:
            "❌ Un avocat est déjà désigné pour cette affaire.",
          ephemeral: true
        });
      }
      ...
      if (!channel) {
        return interaction.reply({
          content:
            "❌ Le salon de l'affaire est introuvable.",
          ephemeral: true
        });
      }
